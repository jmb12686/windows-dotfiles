...
# Power: Disable Standby while on AC power.
powercfg /change /standby-timeout-ac 0
# Power: Disable Monitor sleep while on AC power.
powercfg -change -monitor-timeout-ac 10
# Power: Put computer to sleep (standby) after 10 minutes while on battery
powercfg -change -standby-timeout-dc 10
# Power: Put display to sleep after 5 minutes on battery
